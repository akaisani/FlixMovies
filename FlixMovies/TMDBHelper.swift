...
struct TMDBHelper {
    ...
    func getSuperheroMovies(_ completion: @escaping ([[String: Any]]?, String?) -> Void) {
    ...
    static func fetchMovies(for viewController: UIViewController, from urlString: String, _ completion: @escaping ([Movie]) -> Void) {
        var movies: [Movie] = []
        TMDBHelper.getMovieData(from: urlString) {
